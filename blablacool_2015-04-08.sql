...
# Database: blablacool
# Generation Time: 2015-04-08 17:06:57 +0000
# ************************************************************
...
VALUES
	...
	(2,9,25,1,'ACCEPTED',NULL,'2015-04-07 20:20:51'),
	(3,1,1,1,'PENDING',NULL,'2015-04-08 12:23:59');
...
VALUES
	...
	(10,1,1,'Ceci est un test de message !','2015-04-08 12:23:45');
...
VALUES
	...
	(31,'Amiens','Private Name',49.894067000000000000,2.295752999999990600,'49.894067,2.295753','Amiens, France','','','','Amiens','France','FR',1),
	(32,'Paris','Private Name',48.856614000000000000,2.352221900000017700,'48.856614,2.352222','Paris, France','','','','Paris','France','FR',1),
	(33,'Annecy','Private Name',45.899247000000000000,6.129383999999959000,'45.899247,6.129384','Annecy, France','','','','Annecy','France','FR',1),
	(34,'Lyon','Private Name',45.764043000000000000,4.835658999999964000,'45.764043,4.835659','Lyon, France','','','','Lyon','France','FR',1),
	(35,'Théoule-sur-Mer','Private Name',43.505623000000000000,6.940983999999958000,'43.505623,6.940984','Théoule-sur-Mer, France','','','','Théoule-sur-Mer','France','FR',1),
	(36,'Sainte-Maxime','Private Name',43.310184000000000000,6.640482000000020000,'43.310184,6.640482','Sainte-Maxime, France','','','','Sainte-Maxime','France','FR',1),
	(37,'Toulouse','Private Name',43.604652000000000000,1.444209000000000700,'43.604652,1.444209','Toulouse, France','','','','Toulouse','France','FR',1),
	(38,'Lyon','Private Name',45.764043000000000000,4.835658999999964000,'45.764043,4.835659','Lyon, France','','','','Lyon','France','FR',1);
...
VALUES
	(5,1,1,3,'Test','2015-04-07 20:55:37'),
	(6,1,2,5,'Test 2','2015-04-07 20:55:46');
...
VALUES
	...
	(31,1,'2015-04-08 12:30:00',31,11),
	(32,2,'2015-04-08 14:30:00',32,11),
	(33,1,'2015-04-08 13:00:00',33,12),
	(34,2,'2015-04-08 14:30:00',34,12),
	(35,1,'2015-04-08 12:45:00',35,13),
	(36,2,'2015-04-08 15:00:00',36,13),
	(37,1,'2015-04-08 13:30:00',37,14),
	(38,2,'2015-04-08 18:00:00',38,14);
...
VALUES
	...
	(11,1,4,0,0,'NORMAL',10.00),
	(12,1,4,0,0,'NORMAL',10.00),
	(13,1,4,0,0,'NORMAL',5.00),
	(14,1,4,0,0,'NORMAL',36.00);
...
VALUES
	(1,'Valentin','Polo','VP42','me@vpolo.fr','$2a$10$2o6eO.SpCvk2nFbqQOPg7.jIQQBQKSW1hNftaIbmMsoIqw9FCkOdS',NULL,'0897660006','Adresse','Boulogne sur Mer','Pas-de-Calais','62200','France');
...
VALUES
	(1,1,0,'Rap',1,'Avenant','Un peu','Sportive','àààà');
