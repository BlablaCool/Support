...
-- -----------------------------------------------------
-- Table `blablacool`.`trip_has_passengers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blablacool`.`trip_has_passengers` ;

CREATE TABLE IF NOT EXISTS `blablacool`.`trip_has_passengers` (
  `trip_id` INT NOT NULL,
  `passenger_id` INT NOT NULL,
  PRIMARY KEY (`trip_id`, `passenger_id`),
  INDEX `fk_trip_has_user_user1_idx` (`passenger_id` ASC),
